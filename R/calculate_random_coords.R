...
#'
#' @examples
#' calculate_random_coords(species = "Beech, n = 10)
#'
#' @aliases calculate_random_coords
#' @rdname calculate_random_coords
#'
#' @references
...
#                                    kernel = calculate_seed_kernel(species = species,distance = proposed,
