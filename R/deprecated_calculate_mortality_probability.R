#' deprecated_calculate_mortality_probability
#'
...
#'
#' @examples
#' deprecated_calculate_mortality_probability(species = "Beech", dbh = 25.31)
#'
#' @aliases deprecated_calculate_mortality_probability
#' @rdname deprecated_calculate_mortality_probability
#'
#' @references
...
#'
#' @export
deprecated_calculate_mortality_probability <- function(species, dbh){
