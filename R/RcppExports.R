...
rcpp_calculate_actual_abiotic <- function(matrix, alpha, beta, mod, gamma, max_dist) {
    .Call('_rabmp_rcpp_calculate_actual_abiotic', PACKAGE = 'rabmp', matrix, alpha, beta, mod, gamma, max_dist)
}

rcpp_calculate_actual_biotic <- function(matrix, alpha, beta, mod, max_dist) {
    .Call('_rabmp_rcpp_calculate_actual_biotic', PACKAGE = 'rabmp', matrix, alpha, beta, mod, max_dist)
}
